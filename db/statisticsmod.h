...
#include<climits>
namespace leveldb{
    const char statisticsString[][50]={"WAIT","WRITETOLOG","WRITETOMEMTABLE","ARENAALLOCATE","MEMCPY","TABLEINSERT","MEMTABLEADD","NEWNODE"};
    enum Statistics{
      WAIT,WRITETOLOG,WRITETOMEMTABLE,ARENAALLOCATE,MEMCPY,TABLEINSERT,MEMTABLEADD,NEWNODE,STATISTICSNUMLENGTH
    };
    class StatisticsMod {
