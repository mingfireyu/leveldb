...
#include<climits>
namespace leveldb{
    const char statisticsString[][50]={"WAIT","WRITETOLOG","WRITETOMEMTABLE","ARENAALLOCATE","MEMCPY","TABLEINSERT","MEMTABLEADD","NEWNODE","FINDEQUAL","MAXHEIGHT","SETNEXT"};
    enum Statistics{
      WAIT,WRITETOLOG,WRITETOMEMTABLE,ARENAALLOCATE,MEMCPY,TABLEINSERT,MEMTABLEADD,NEWNODE,FINDEQUAL,MAXHEIGHT,SETNEXT,STATISTICSNUMLENGTH
    };
    class StatisticsMod {
